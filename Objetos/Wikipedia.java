 ...
 */
public class Wikipedia extends Objeto {

	public static String buscar(String mensaje) {
		String regex = "";
		...
		return "No pude conseguir la informacion";
	}

	private static String obtenerTituloYVistaPrevia(String url) {
		...
		return "No se pudo conseguir la informacion";
	}
