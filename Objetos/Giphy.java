 ...
 */
public class Giphy extends Objeto {

	static private Pattern regex = Pattern.compile("de (.*)");
	static private Pattern regexGif = Pattern.compile("media/(.+)/gip");
	...
	public static String mostrame(String mensaje) {
		...
		return "Disculpa, pero no te entendi";
	}

	private static String obtenerTodo(String tema) {
